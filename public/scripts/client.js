  ...
  $("form").on('submit', function (event) {
    ...
    $.ajax({
      ...
      .then(() => {
        ...
        //when clearing out the tweets-container, the cut off is visible while loading, instead of clearing the whole tweet section and calling loadtweets,I decided to get only the new tweet so that the clearing is not visible and it seems load be faster as well. below is the code that clears the tweet:
